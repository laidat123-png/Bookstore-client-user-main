                                    ...
                                    {review.map((rv, index) => {
                                        return (
                                            <li className="review-tab_commentItem" key={rv?._id}>
                                                <img className="commentItem-avartar" 
                                                    alt="Ảnh đại diện" 
                                                    src={rv.userID && rv.userID.image ? rv.userID.image : '/kotontai.jpg'}  />
                                                <div className="commentItem-text">
                                                    <div className="commentItem-meta-star">
                                                        <p className="commentItem-meta">
                                                            <strong className="commentItem-author">
                                                            {rv.userID ? `${rv.userID.firstName || ''} ${rv.userID.lastName || ''}` : 'Tài khoản đã bị xóa'}
                                                            </strong>
                                                            <span>-</span>
                                                            <time dateTime={new Date(rv.date).toISOString()}>{new Date(rv.date).toLocaleString()}</time>
                                                        </p>
